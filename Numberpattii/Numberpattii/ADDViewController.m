...
- (void)buttonClicked:(UIButton *)btn{
    ...
    }else if (self.threeint==-1){
        self.imagethree.image=[UIImage imageNamed:[NSString stringWithFormat:@"%ld",btnint-1]];
        self.threeint=btnint-1;
    }else if (self.fourint==-1){
        self.imagefour.image=[UIImage imageNamed:[NSString stringWithFormat:@"%ld",btnint-1]];
        self.fourint=btnint-1;
    }
...
-(void)updateimageview{
    ...
    if ([self.fuhaostring isEqualToString:@"/"]) {
        self.imagefuhao.image=[UIImage imageNamed:@"123456"];
    }else{
